export class RhinoDisplayedInTable {

    rhinoDisplayed(name, species){
        ...
        cy.get('table').should('contain', 'speciess')
    }

}

export const onRhinoDisplaed = new RhinoDisplayedInTable()